...
class ProxyHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        # Set User-Agent to the simulated browser UA so APM server indexes the
        # correct browser/OS/device fields (it reads from the HTTP request header,
        # not from the NDJSON body).
